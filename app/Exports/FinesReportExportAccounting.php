...
class FinesReportExportAccounting implements FromCollection, WithHeadings, WithEvents, WithCustomStartCell
{
    protected $startDate;
    protected $endDate;
    protected $itemName;
    ...
    private function addFooter($sheet)
{
    ...
    // Generated By
    $generatedBy = Auth::guard('accounting')->user()->full_name ?? 'N/A';
