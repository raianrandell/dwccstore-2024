...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <a href="{{ route('accounting.total_item_report.pdf', request()->query()) }}" class="btn btn-danger me-2">
            <i class="fas fa-file-pdf"></i> Export PDF
        </a>
        <a href="{{ route('accounting.total_item_report.excel', request()->query()) }}" class="btn btn-success">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('accounting.total_item_report') }}">
            <div class="row align-items-end">
                ...
                <!-- Reset Button -->
                <div class="col-md-1 d-flex align-items-end">
                    <a href="{{ route('accounting.total_item_report') }}" class="btn btn-secondary w-100">
