...
<ol class="breadcrumb mb-3 mt-5">
    ...
    <li class="breadcrumb-item active"><a href="{{ route('accounting.void_report') }}">Void Logs Report</a></li>
</ol>
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('accounting.void_report') }}">
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-2 d-flex align-items-end">
                    <!-- Reset Button -->
                    <a href="{{ route('accounting.void_report') }}" class="btn btn-secondary w-100">
