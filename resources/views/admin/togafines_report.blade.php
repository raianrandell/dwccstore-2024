...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
       <!-- Export PDF with All Filters -->
        <a href="{{ route('admin.toga_fines_report_pdf', request()->query()) }}" class="btn btn-danger me-2">
            <i class="fas fa-file-pdf"></i> Export PDF
        </a>

        <!-- Export Excel with All Filters -->
        <a href="{{ route('admin.toga_fines_report_excel', request()->query()) }}" class="btn btn-success">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('admin.toga_fines_report') }}">
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-1 d-flex align-items-end">
                    <a href="{{ route('admin.toga_fines_report') }}" class="btn btn-secondary w-100">
