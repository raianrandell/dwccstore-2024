...
<body class="sb-nav-fixed">
    ...
    @include('layout.partials.cashier.navbar_cashier') <!-- Update navbar for inventory -->

    <div id="layoutSidenav">

        <div id="layoutSidenav_nav">
            @include('layout.partials.cashier.sidebar_cashier') <!-- Update sidebar for inventory -->
        </div>
